defmodule Artemis.Repo.GenerateData do
  ...
  def call() do
    ...
    permissions = [
      ...
      %{slug: "event-answers:create", name: "Event Answers - Create"},
      %{slug: "event-answers:delete", name: "Event Answers - Delete"},
      %{slug: "event-answers:list", name: "Event Answers - List"},
      %{slug: "event-answers:show", name: "Event Answers - Show"},
      %{slug: "event-answers:update", name: "Event Answers - Update"},
      %{slug: "event-integrations:create", name: "Event Integrations - Create"},
      %{slug: "event-integrations:delete", name: "Event Integrations - Delete"},
      %{slug: "event-integrations:list", name: "Event Integrations - List"},
      %{slug: "event-integrations:show", name: "Event Integrations - Show"},
      %{slug: "event-integrations:update", name: "Event Integrations - Update"},
      %{slug: "event-questions:create", name: "Event Questions - Create"},
      %{slug: "event-questions:delete", name: "Event Questions - Delete"},
      %{slug: "event-questions:list", name: "Event Questions - List"},
      %{slug: "event-questions:show", name: "Event Questions - Show"},
      %{slug: "event-questions:update", name: "Event Questions - Update"},
      %{slug: "event-reports:list", name: "Event Reports - List"},
      ...
      %{slug: "github-issues:list", name: "Github Issues - List"},
      %{slug: "github-issues:show", name: "Github Issues - Show"},
      ...
      %{slug: "key-values:create", name: "Key Values - Create", description: admin_only},
      %{slug: "key-values:delete", name: "Key Values - Delete", description: admin_only},
      %{slug: "key-values:list", name: "Key Values - List", description: admin_only},
      %{slug: "key-values:show", name: "Key Values - Show", description: admin_only},
      %{slug: "key-values:update", name: "Key Values - Update", description: admin_only},
      ...
      %{slug: "projects:create", name: "Projects - Create"},
      %{slug: "projects:delete", name: "Projects - Delete"},
      %{slug: "projects:list", name: "Projects - List"},
      %{slug: "projects:show", name: "Projects - Show"},
      %{slug: "projects:update", name: "Projects - Update"},
      %{slug: "reactions:create", name: "Reactions - Create"},
      %{slug: "reactions:delete", name: "Reactions - Delete"},
      %{slug: "reactions:list", name: "Reactions - List"},
      %{slug: "reactions:show", name: "Reactions - Show"},
      %{slug: "reactions:update", name: "Reactions - Update"},
      %{slug: "recognitions:access:all", name: "Recognitions - Access All", description: admin_only},
      %{slug: "recognitions:access:self", name: "Recognitions - Access Self"},
      %{slug: "recognitions:create", name: "Recognitions - Create"},
      %{slug: "recognitions:delete", name: "Recognitions - Delete"},
      %{slug: "recognitions:list", name: "Recognitions - List"},
      %{slug: "recognitions:show", name: "Recognitions - Show"},
      %{slug: "recognitions:update", name: "Recognitions - Update"},
      ...
      %{slug: "user-anonymizations:create", name: "User Anonymizations - Create", description: admin_only},
      %{slug: "user-impersonations:create", name: "User Impersonations - Create", description: admin_only},
      ...
      %{slug: "user-teams:create", name: "User Teams - Create"},
      %{slug: "user-teams:delete", name: "User Teams - Delete"},
      %{slug: "user-teams:list", name: "User Teams - List"},
      %{slug: "user-teams:show", name: "User Teams - Show"},
      %{slug: "user-teams:update", name: "User Teams - Update"},
    ...
    permission_slugs = [
      ...
      "event-integrations:create",
      "event-integrations:delete",
      "event-integrations:list",
      "event-integrations:show",
      "event-integrations:update",
